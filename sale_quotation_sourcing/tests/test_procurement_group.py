...
class TestProcurementGroup(TransactionCase):
    def test_sourced_by_no_po(self):
        ...
        self.assertEqual(so_line.procurement_group_id.name, self.sale.name)
    ...
    def test_all_sourced_by_a_single_po(self):
        ...
        self.assertEqual(so_line1.procurement_group_id.name,
    ...
    def test_sourced_by_multiple_po(self):
        ...
        self.assertEqual(so_line1.procurement_group_id.name,
                         self.sale.name + '/' + self.po1.name)
        self.assertEqual(so_line2.procurement_group_id.name,
